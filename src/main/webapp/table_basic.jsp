        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <span class="mainDescription">Refers to data arranged in rows and columns. A spreadsheet, for example, is a table. In relational database management systems, all information is stored in the form of tables. <small
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                For basic styling&mdash;light padding and only horizontal dividers&mdash;add the base
                                class <code>.table</code> to any <code>&lt;table&gt;</code>. It may seem super
                                redundant, but given the widespread use of tables for other plugins like calendars and
                                    ...
                                    <td class="center">
                                        <div class="visible-md visible-lg hidden-sm hidden-xs">
                                            ...
                                            <a href="#" class="btn btn-transparent btn-xs tooltips"
                                               tooltip-placement="top" tooltip="Share"><i class="fa fa-share"></i></a>
                                            <a href="#" class="btn btn-transparent btn-xs tooltips"
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15">Striped <span class="text-bold">rows</span></h5>
                            <p>
                            ...
                            <table class="table table-striped table-hover" id="sample-table-2">
                                ...
                                <tr>
                                    <td class="center"><img src="assets/images/avatar-2.jpg" class="img-rounded"
                                                            alt="image"/></td>
                                    <td>Nicole Bell</td>
                                ...
                                <tr>
                                    <td class="center"><img src="assets/images/avatar-3.jpg" class="img-rounded"
                                                            alt="image"/></td>
                                ...
                                <tr>
                                    <td class="center"><img src="assets/images/avatar-4.jpg" class="img-rounded"
                                                            alt="image"/></td>
                                ...
                                <tr>
                                    <td class="center"><img src="assets/images/avatar-5.jpg" class="img-rounded"
                                                            alt="image"/></td>
                                    <td>Kenneth Ross</td>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="over-title margin-bottom-15">Condensed <span class="text-bold">table</span></h5>
                            <p>
                                Add <code>.table-condensed</code> to make tables more compact by cutting cell padding in
                                half.
                            </p>
                            <table class="table table-condensed table-hover" id="sample-table-3">
                                ...
                                <tr>
                                    ...
                                    <td>Feb 13</td>
                                    <td class="hidden-xs"><span class="label label-sm label-warning">Expiring</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <div class="col-md-6">
                            <h5 class="over-title margin-bottom-15">Bordered <span class="text-bold">table</span></h5>
                            <p>
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15">Contextual <span class="text-bold">classes</span>
                            </h5>
                            <p>
