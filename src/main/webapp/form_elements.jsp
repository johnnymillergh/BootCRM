        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                            ...
                            <div class="row margin-top-30">
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small margin-bottom-20">
                                                All textual <code>&lt;input&gt;</code>, <code>&lt;textarea&gt;</code>,
                                                and <code>&lt;select&gt;</code> elements with <code>.form-control</code>
                                                are set to <code>width: 100%;</code> by default. Wrap labels and
                                                controls in <code>.form-group</code> for optimum spacing.
                                            </p>
                                            <form role="form">
                                                <div class="form-group">
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small margin-bottom-20">
                                                ...
                                                form controls in a horizontal layout by adding
                                                <code>.form-horizontal</code> to the form. Doing so changes <code>.form-group</code>s
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small margin-bottom-20">
                                                Add <code>.form-inline</code> to your <code>&lt;form&gt;</code> for
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="over-title margin-bottom-15">Alternative <span class="text-bold">example</span>
                            </h5>
                            <p>
                                ...
                                <div class="panel-body">
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control underline" id="exampleInputEmail1"
                                                   placeholder="Enter email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">
                                            ...
                                            <input type="password" class="form-control underline"
                                                   id="exampleInputPassword1" placeholder="Password">
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="password" placeholder="Password" id="inputPassword3"
                                                       class="form-control underline">
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="panel panel-white no-radius">
                                ...
                                <div class="panel-body">
                                    <form role="form" class="margin-bottom-20">
                                        <div class="form-group">
                                            <input type="text" placeholder="Large Text Field" id="form-field-12"
                                                   class="form-control input-lg">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Standard Text Field" id="form-field-13"
                                                   class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Small Text Field" id="form-field-13"
                            ...
                            <div class="panel panel-white no-radius">
                                ...
                                <div class="panel-body">
                                    <form role="form">
                                        <div class="form-group">
                                            <input type="text" placeholder="Large Text Field" id="form-field-12"
                                                   class="form-control underline input-lg">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Standard Text Field" id="form-field-12"
                                                   class="form-control underline">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Small Text Field" id="form-field-13"
                                                   class="form-control underline input-sm">
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="margin-bottom-30">
                                <code>&lt;fieldset&gt;</code> is used as a wrapper right inside the form element. Right
                                after you define a fieldset, you can include a legend title by using <code>&lt;legend&gt;</code>.
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="email" placeholder="Text Field" name="email" id="email"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Disabled" id="form-field-21"
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Readonly" value="Readonly value"
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15">Icons &amp; <span class="text-bold">Helpers</span>
                            </h5>
                            <div class="row">
                                        ...
                                        <div class="panel-body">
                                            <form role="form">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Text Field" id="form-field-6"
                                                           class="form-control">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-sm-6">
                                                            <input type="text" placeholder="Text Field"
                                                                   id="form-field-7" class="form-control">
                                                        </div>
                                                        <span class="help-inline col-md-4 col-sm-6"> <i
                                                                class="ti-info-alt text-primary"></i> Inline help text </span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                    ...
                                                    <input type="text" value="Click me!"
                                                           tooltip="See? Now click away..." tooltip-trigger="focus"
                                                           tooltip-placement="top" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        Popover
                                                    </label>
                                                    <input type="text" value="Click me!" popover-title="Title"
                                                           popover-placement="top" popover="Hello, World!"
                                                           class="form-control"/>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <form role="form">
                                                <div class="form-group">
                                                    ...
                                                    <span class="input-icon">
																<input type="text" placeholder="Text Field"
                                                                       id="form-field-14" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span class="input-icon input-icon-right">
																<input type="text" placeholder="Text Field"
                                                                       id="form-field-17" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                Use the <code>.checkbox-inline</code> classes on a series of checkboxes
                                                for controls that appear on the same line.
                                            </p>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                Use the <code>.radio-inline</code> classes on a series of radios for
                                                controls that appear on the same line.
                                            </p>
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="radio clip-radio radio-primary">
                                                <input type="radio" id="radio6" name="vertical" value="radio6"
                                                       disabled="">
                                                <label for="radio6">
                                                    Radio 4 (disabled)
                                                </label>
                                ...
                                <div class="col-sm-4">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <div class="radio clip-radio radio-primary radio-inline">
                                                <input type="radio" id="radio7" name="radio7" value="radio7"
                                                       checked="checked">
                                                <label for="radio7">
                                                    Radio 1
                                                </label>
                                            ...
                                            <div class="radio clip-radio radio-success radio-inline">
                                                <input type="radio" id="radio8" name="radio8" value="radio8"
                                                       checked="checked">
                                                <label for="radio8">
                                                    Radio 2
                                                </label>
                                            ...
                                            <div class="radio clip-radio radio-warning radio-inline">
                                                <input type="radio" id="radio9" name="radio9" value="radio9"
                                                       checked="checked">
                                                <label for="radio9">
                                                    Radio 3
                                                </label>
                                            ...
                                            <div class="radio clip-radio radio-danger radio-inline">
                                                <input type="radio" id="radio10" name="radio10" value="radio10"
                                                       checked="checked">
                                                <label for="radio10">
                                                    Radio 4
                                                </label>
                                            ...
                                            <div class="radio clip-radio radio-info radio-inline">
                                                <input type="radio" id="radio11" name="radio11" value="radio11"
                                                       checked="checked">
                                                <label for="radio11">
                                                    Radio 5
                                                </label>
                                            ...
                                            <div class="radio clip-radio radio-purple radio-inline">
                                                <input type="radio" id="radio12" name="radio12" value="radio12"
                                                       checked="checked">
                                                <label for="radio12">
                                                    Radio 6
                                                </label>
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="margin-bottom-30">
                                Masked Input allows users to enter the data in a certain format (dates, phone numbers,
                                etc).
                            </p>
                            <div class="row">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="form-field-mask-1"
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="form-field-mask-2"
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="form-field-mask-3"
                                                           class="form-control input-mask-product">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <textarea placeholder="Default Text" id="form-field-22"
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <textarea maxlength="50" id="form-field-23"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="margin-bottom-30">
                                ...
                                User can navigate through months and years. The datepicker shows dates that come from
                                other than the main month being displayed. These other dates are also selectable.
                            </p>
                            <div class="panel panel-white no-radius">
                                <div class="panel-body">
                                    <div class="row">
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select multiple="multiple" id="form-field-select-2"
                                                        class="form-control">
                                                    <option value="AL">Alabama</option>
                                                    <option value="AK">Alaska</option>
                                                    <option value="AZ">Arizona</option>
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="cs-select cs-skin-slide">
                                                    <option value=""></option>
                                                    <option value="sightseeing" data-class="fa fa-apple">Sight Seeing
                                                    </option>
                                                    <option value="business" data-class="fa fa-android">Business
                                                    </option>
                                                    <option value="honeymoon" data-class="fa fa-windows">Honeymoon
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="cs-select cs-skin-elastic">
                                                    ...
                                                    <option value="argentina" data-class="fa fa-windows">Argentina
                                                    </option>
                                                    <option value="south-africa" data-class="fa fa-dropbox">South
                                                        Africa
                                                    </option>
                                                    <option value="shopping" data-class="fa fa-github">Shopping</option>
                                                </select>
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="margin-bottom-30">
                                A mobile and touch friendly input spinner component for Bootstrap. It supports the
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="panel panel-white min-height-270">
                                        ...
                                        <div class="panel-body">
                                            <p class="margin-bottom-30">
                                                The init value is set on the input with the <code>value</code>
                                                attribute.
                                            </p>
                                            <div class="form-group">
                                                <label>
                                                ...
                                                <input id="demo1" type="text" value="55" name="demo1" touchspin
                                                       data-min="0" data-max="100" data-step="0.1" data-decimals="2"
                                                       data-boostat="5" data-maxboostedstep="10">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-white min-height-270">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="demo1" type="text" value="0" name="demo1" touchspin
                                                       data-min="-1000000000" data-max="1000000000"
                                                       data-stepinterval="50" data-maxboostedstep="10000000"
                                                       data-prefix="$">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel panel-white min-height-270">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="demo4" type="text" value="0" name="demo4" touchspin
                                                       data-verticalbuttons="true" data-verticalupclass="ti-angle-up"
                                    ...
                                    <div class="panel panel-white min-height-270">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="demo5" type="text" value="0" name="demo5" touchspin
                                                       data-postfix="button" data-postfix_extraclass="btn btn-default">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="panel panel-white min-height-270">
                                        ...
                                        <div class="panel-body">
                                            <p class="margin-bottom-30">
                                                Size of the whole controller can be set with applying input-sm or
                                                input-lg class on the input
                                            </p>
                                            <div class="form-group">
                                                <label>
                                                    Button postfix (large)
                                                </label>
                                                <input id="demo6" type="text" value="0" name="demo6"
                                                       class="form-control input-lg" touchspin data-postfix="button"
                                                       data-postfix_extraclass="btn btn-default">
                                            </div>
                                        </div>
                                    </div>
                                </div>
