        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Modals</h1>
                            <span class="mainDescription">A modal window is any type of window that is a child (secondary window) to a parent window and usurps the parent's control. <small
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15">Bootstrap <span class="text-bold">Modals</span></h5>
                            <p>
                            ...
                            <div class="row">
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="margin-bottom-30">
                                                Toggle a modal by clicking the button below. It will slide down and fade
                                                in from the top of the page.
                                            </p>
                                            <button class="btn btn-primary btn-o pull-right" data-toggle="modal"
                                                    data-target="#myModal">
                                                Open Deafult Modal
                                            </button>
                                        </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="margin-bottom-30">
                                                Modals have a large optional size, available by setting option <code>size:
                                                'lg'</code> in the method <code>open(options)</code>
                                            </p>
                                            <button class="btn btn-primary btn-o pull-right" data-toggle="modal"
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="margin-bottom-30">
                                                Modals have a small optional size, available by setting option <code>size:
                                                'sm'</code> in the method <code>open(options)</code>
                                            </p>
                                            <button class="btn btn-primary btn-o pull-right" data-toggle="modal"
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <!-- Up Aside -->
                                <div class="modal fade modal-aside vertical top bs-example-modal-up" tabindex="-1"
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <button type="button"
                                                    class="btn btn-primary btn-block btn-scroll btn-scroll-top ti-arrow-up"
                                                    data-toggle="modal" data-target=".bs-example-modal-up">
                                                <span>Up</span>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <!-- Left Aside -->
                                <div class="modal fade modal-aside horizontal left bs-example-modal-left" tabindex="-1"
                                     role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog modal-sm">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <button type="button"
                                                    class="btn btn-primary btn-block btn-scroll btn-scroll-top ti-arrow-left"
                                                    data-toggle="modal" data-target=".bs-example-modal-left">
                                                <span>Left</span>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <!-- Down Aside -->
                                <div class="modal fade modal-aside vertical bottom bs-example-modal-bottom"
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <button type="button"
                                                    class="btn btn-primary btn-block btn-scroll btn-scroll-top ti-arrow-down"
                                                    data-toggle="modal" data-target=".bs-example-modal-bottom">
                                                <span>Down</span>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <!-- Right Aside -->
                                <div class="modal fade modal-aside horizontal right bs-example-modal-right"
                                     tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog modal-sm">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <button type="button"
                                                    class="btn btn-primary btn-block btn-scroll btn-scroll-top ti-arrow-right"
                                                    data-toggle="modal" data-target=".bs-example-modal-right">
                                                <span>Right</span>
                                            </button>
                                        </div>
                                    </div>
