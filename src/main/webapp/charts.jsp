        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Charts</h1>
                            <span class="mainDescription">Simple, clean and engaging charts for designers and developers.</span>
                        </div>
                        <ol class="breadcrumb">
                            <li class="active">
                                <span>Charts</span>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <p>
                                        ...
                                        in CSS format.
                                        We have an array of labels too for display. In the example, we are showing the
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <p>
                                        ...
                                        They are divided into segments, the arc of each segment shows the proportional
                                    ...
                                    <p>
                                        ...
                                        different default value - their <code>percentageInnerCutout</code>. This equates
                                        what percentage of the inner should be cut out. This defaults to <code>0</code>
                                        for pie charts, and <code>50</code> for doughnuts.
                                    </p>
                                    <p class="margin-top-20">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p>
                                        A radar chart is a way of showing multiple data points and the variation between
                                        them.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        array of strings that show around each point in the chart.
                                        ...
                                        point, and a colour for the stroke of each point. We also have an array of data
                                        values.
                                    </p>
                                    <p class="margin-top-20">
