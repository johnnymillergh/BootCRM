        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Tabs &amp; Accordions</h1>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                Add quick, dynamic tab functionality to transition through panes of content, even via
                                dropdown menus.
                            </p>
                            <div class="tabbable">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="myTab1_example3">
                                        <p>
                                            ...
                                            cliche high life echo park Austin.
                                        </p>
                                        <p>
                                            Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip
                                            placeat salvia cillum iphone. Seitan aliquip quis cardigan american apparel,
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="over-title margin-bottom-15">Justified <span class="text-bold">Tabs</span></h5>
                            <p>
                                Easily make tabs or pills equal widths of their parent. On smaller screens, the nav
                                links are stacked.
                            </p>
                            <div class="tabbable">
                        ...
                        <div class="col-lg-6">
                            <h5 class="over-title margin-bottom-15"><span class="text-bold">Pills</span></h5>
                            <p>
                                Take that same HTML, but use <code>type="pills"</code> attribute:
                            </p>
                ...
                <div class="container-fluid container-fullw  bg-white">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="over-title margin-bottom-15">Left <span class="text-bold">Tabs</span></h5>
                            <p>
                                Add class <code>tabs-left</code> to <code>&lt;tabset&gt;</code>.
                            </p>
                        ...
                        <div class="col-lg-6">
                            <h5 class="over-title margin-bottom-15">Right <span class="text-bold">Tabs</span></h5>
                            <p>
                                Add class <code>tabs-right</code> to <code>&lt;tabset&gt;</code>.
                            </p>
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="over-title margin-bottom-15"><span class="text-bold">Bootsrap Accordions</span>
                            </h5>
                            <p>
