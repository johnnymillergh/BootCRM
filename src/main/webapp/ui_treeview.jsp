        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">TreeView</h1>
                            <span class="mainDescription">A type of data structure in which each element is attached to one or more elements directly beneath it. The connections between elements are called branches. <small
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                jsTree is jquery plugin, that provides interactive trees. jsTree is easily extendable,
                                themable and configurable, it supports HTML & JSON data sources and AJAX loading.
                            </p>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h4 class="panel-title"> Drag &amp; Drop <span class="text-bold">Tree</span>
                                            </h4>
                                        </div>
                                        <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <input type="text" class="form-control margin-bottom-10" value=""
                                                   id="tree_4_search" placeholder="Search">
