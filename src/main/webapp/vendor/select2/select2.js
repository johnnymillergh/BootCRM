(function () {
    ...
    if (window.jQuery && jQuery.fn && jQuery.fn.select2 && jQuery.fn.select2.amd) {
        var define = jQuery.fn.select2.amd.define;
        var require = jQuery.fn.select2.amd.require;
    }
    /**
...
//be followed.
    ...
    define('select2/diacritics', [], function () {
        var diacritics = {
            '\u24B6': 'A',
            '\uFF21': 'A',
            '\u00C0': 'A',
    ...
    define('select2/data/minimumInputLength', [], function () {
    ...
    define('select2/data/maximumInputLength', [], function () {
    ...
    define('select2/data/maximumSelectionLength', [], function () {
    ...
    define('select2/dropdown/hidePlaceholder', [], function () {
    ...
    define('select2/dropdown/minimumResultsForSearch', [], function () {
    ...
    define('select2/dropdown/selectOnClose', [], function () {
    ...
    define('select2/dropdown/closeOnSelect', [], function () {
