        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Pricing Table</h1>
                            ...
                            <div class="pricing-table">
                                <div class="col-lg-3 col-md-3 col-xs-6">
                                    <ul class="plan plan1">
                                        ...
                                        <li class="plan-price">
                                            <h3> $19 <span class="price-cents">99</span><span
                                                    class="price-month">/month</span></h3>
                                        </li>
                                        <li>
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-6">
                                    <ul class="plan plan2 featured">
                                        ...
                                        <li class="plan-price">
                                            <h3> $29 <span class="price-cents">99</span><span
                                                    class="price-month">/month</span></h3>
                                        </li>
                                        <li>
                                            <strong>5GB</strong> Storage
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-6">
                                    <ul class="plan plan3">
                                        ...
                                        <li class="plan-price">
                                            <h3> $49 <span class="price-cents">99</span><span
                                                    class="price-month">/month</span></h3>
                                        </li>
                                        <li>
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-6">
                                    <ul class="plan plan4">
                                        ...
                                        <li class="plan-price">
                                            <h3> $99 <span class="price-cents">99</span><span
                                                    class="price-month">/month</span></h3>
                                        </li>
                                        <li>
                                            <strong>50GB</strong> Storage
