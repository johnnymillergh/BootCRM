        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Toggle</h1>
                            <span class="mainDescription">A simple but useful and efficient function to toggle a class to an element</span>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15">Lightbulb <span class="text-bold">Example</span>
                            </h5>
                            <p>
                                The class is specified in the <code>data-toggle-class</code> attribute (in this example
                                <code>text-primary</code>). The element is indicated by <code>data-toggle-target</code>.
                            </p>
                            <p class="text-center big-icon" id="lightbulb">
                                <i class="fa fa-lightbulb-o"></i>
                            </p>
                            <div class="btn-group btn-group-justified margin-bottom-30">
                                <a href class="btn btn-o btn-primary" data-toggle-target="#lightbulb"
                                   data-toggle-class="text-primary">
                                    Toggle
                                </a>
                                <a href class="btn btn-o btn-primary" data-toggle-target="#lightbulb"
                                   data-toggle-class="text-primary" data-toggle-type="on">
                                    Turn On
                                </a>
                                <a href class="btn btn-o btn-primary" data-toggle-target="#lightbulb"
                                   data-toggle-class="text-primary" data-toggle-type="off">
                                    Turn Off
                                </a>
                            </div>
                            <p>
                                Through the attribute <code>data-toggle-type</code>, the buttons can activate ("on"), or
                                turn off ("off") class to the target element (which is indicated by its ID)
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-center big-icon" id="heart">
                                <i class="fa fa-heart-o"></i>
                            </p>
                            <div class="btn-group btn-group-justified margin-bottom-30">
                                <a href class="btn btn-o btn-primary" data-toggle-target="#heart"
                                   data-toggle-class="heart-pulse">
                                    Toggle
                                </a>
                                <a href class="btn btn-o btn-primary" data-toggle-target="#heart"
                                   data-toggle-class="heart-pulse" data-toggle-type="on">
                                    Turn On
                                </a>
                                <a href class="btn btn-o btn-primary" data-toggle-target="#heart"
                                   data-toggle-class="heart-pulse" data-toggle-type="off">
                                    Turn Off
                                </a>
                            </div>
                        </div>
