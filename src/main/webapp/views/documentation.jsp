...
<!-- start: HEAD -->
<head>
    <title>BootCRM - Documentation</title>
...
<div id="app">
    ...
    <div class="app-content">
        ...
        <header class="navbar navbar-default navbar-static-top">
            ...
            <div class="navbar-header">
                <a href="${basePath}#" class="sidebar-mobile-toggler pull-left hidden-md hidden-lg"
                ...
                <a href="${basePath}#" class="sidebar-toggler pull-right visible-md visible-lg"
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-right">
                        ...
                        <ul class="dropdown-menu dropdown-light dropdown-messages dropdown-large">
                            ...
                            <li>
                                <div class="drop-down-wrapper ps-container">
                                    <ul>
                                        <li class="unread">
                                            <a href="${basePath}javascript:;" class="unread">
                                                <div class="clearfix">
                            ...
                            <li>
                                <div class="drop-down-wrapper ps-container">
                                    <div class="list-group no-margin">
                                        <a class="media list-group-item" href="${basePath}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul role="menu" class="dropdown-menu dropdown-light fadeInUpShort">
                            <li>
                                <a href="${basePath}#" class="menu-toggler">
                                    Deutsch
                                </a>
                            </li>
                            <li>
                    ...
                    <li class="dropdown current-user">
                        ...
                        <ul class="dropdown-menu dropdown-dark">
                            <li>
                                <a href="${basePath}pages_user_profile.jsp">
                                    My Profile
                                </a>
                            </li>
                            <li>
                                <a href="${basePath}pages_calendar.jsp">
                                    My Calendar
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="${basePath}login_lockscreen.jsp">
                                    Lock Screen
                                </a>
                            </li>
                            <li>
                                <a href="${basePath}login_signin.jsp">
                                    Log Out
                                </a>
                            </li>
                        </ul>
                ...
                <div class="close-handle visible-xs-block menu-toggler" data-toggle="collapse" href="${basePath}.navbar-collapse">
  ...
  ...
  &lt;link rel="stylesheet" href="${basePath}assets/css/themes/theme-2.css" id="skin_color"&gt;
  ...</pre>
                            <div class="alert alert-info">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                <a href="${basePath}omnipotent.net/jquery.sparkline" target="_blank"><i class="fa fa-book"></i>
                                    Official Documentation</a>
                            </p>
                            <hr/>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p>
                                        <a class="dropdown-off-sidebar ng-scope" href="${basePath}../RTL/" target="_blank"><i
