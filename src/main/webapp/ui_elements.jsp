                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                List groups are a flexible and powerful component for displaying not only simple lists
                                of elements, but complex ones with custom content.
                            </p>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                ...
                                                and the proper classes. Add the badges component to any list group item
                                                and it will automatically be positioned on the right.
                                            </p>
                                            <ul class="list-group">
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                ...
                                                (that also means a parent <code>&lt;div&gt;</code> instead of an <code>&lt;ul&gt;</code>).
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                ...
                                                includes <code>.active</code> state.
                                            </p>
                                            <div class="list-group">
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                Inspired by the excellent jQuery.tipsy plugin written by Jason Frame; Tooltips are an
                                updated version, which don't rely on images, use CSS3 for animations, and
                                ...
                                <div class="col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body buttons-widget">
                                            <p class="text-small">
                                                The way to initialize all tooltips on a page would be to select them by
                                                their <code>data-toggle="tooltip"</code> attribute
                                            </p>
                                            ...
                                            <button title="" data-placement="bottom" data-toggle="tooltip"
                                                    class="btn btn-primary" type="button"
                                    ...
                                    <div class="panel panel-white">
                                        <div class="panel-body">
                                            ...
                                            <p>
                                                ...
                                                <a href="javascript:void(0)" data-placement="left" data-toggle="tooltip"
                                                   data-original-title="On the Left!">
                                                    left
                                                </a>
                                                eget
                                                arcu dictum varius duis at consectetur lorem. Vitae elementum curabitur
                                                <a href="javascript:void(0)" data-placement="right"
                                                   data-toggle="tooltip" data-original-title="On the Right!">
                                                    right
                                                </a>
                                                nunc sed velit dignissim sodales ut eu sem integer vitae. Turpis egestas
                                                <a href="javascript:void(0)" data-placement="bottom"
                                                   data-toggle="tooltip" data-original-title="On the Bottom!">
                                                    bottom
                                                </a>
                                                pharetra convallis posuere morbi leo urna,
                                                <a href="javascript:void(0)" data-placement="top" data-toggle="tooltip"
                                                   data-original-title="On the Top!">
                                                    top
                                                </a>
                                                at elementum eu, facilisis sed odio morbi quis commodo odio. In cursus
                                                <a href="javascript:void(0)" data-trigger="click" data-placement="top"
                                                   data-toggle="tooltip" data-original-title="appears on click">
                                                    click
                                                </a>
                                            ...
                                            <p>
                                                ...
                                                <a href="javascript:void(0)" data-html="true" data-placement="top"
                                                   data-toggle="tooltip"
                                                   data-original-title="<div class='padding-10'><h3 class='text-white'>Html inside</h3>Tincidunt lobortis feugiat vivamus</div>">
                                                    Check me out!
                                                </a>
                                            </p>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                The way to initialize all tooltips on a page would be to select them by
                                                their <code>data-toggle="popover"</code> attribute
                                            </p>
                                            <button title="" data-toggle="popover" data-placement="left"
                                                    data-title="Popover on left"
                                                    data-content="And here's some amazing content. It's very engaging. Right?"
                                                    class="btn btn-primary btn-o">
                                                Popover on left
                                            </button>
                                            <button title="" data-toggle="popover" data-placement="top"
                                                    data-title="Popover on top"
                                                    data-content="And here's some amazing content. It's very engaging. Right?"
                                                    class="btn btn-primary btn-o">
                                                Popover on top
                                            </button>
                                            <button title="" data-toggle="popover" data-placement="bottom"
                                                    data-title="Popover on bottom"
                                                    data-content="And here's some amazing content. It's very engaging. Right?"
                                                    class="btn btn-primary btn-o">
                                                Popover on bottom
                                            </button>
                                            <button title="" data-toggle="popover" data-placement="right"
                                                    data-title="Popover on right"
                                                    data-content="And here's some amazing content. It's very engaging. Right?"
                                                    class="btn btn-primary btn-o">
                                                Popover on right
                                            </button>
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                ...
                                                <code>&lt;a&gt;</code> tag, <i>not</i> the <code>&lt;button&gt;</code>
                                                tag, and you also must include a <code>tabindex</code> attribute.
                                            </p>
                                            <p>
                                    ...
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <p>
                                                <button title="" data-toggle="popover" data-placement="top"
                                                        data-trigger="hover" data-title="Popover on hover"
                                                        data-content="And here's some amazing content. It's very engaging. Right?"
                                                ...
                                                <button title="" data-toggle="popover" data-placement="top"
                                                        data-html="true"
                                                        data-content="<div class='padding-10 text-center'><h3>Html inside</h3>Tincidunt lobortis feugiat vivamus</div>"
                                                        class="btn btn-primary btn-wide">
                                                    html
                                                </button>
                                            </p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="alert alert-block alert-warning">
                                Progress bars use CSS3 gradients, transitions, and animations to achieve all their
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                jQuery plugin for twitter bootstrap's progressbar for displaying text
                                                and animations. Add class <code>.progress-animated</code> to your
                                                progress-bar.
                                            </p>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <button class="btn btn-primary btn-o margin-bottom-10 active-progressbar"
                                                            type="button">
                                                        Active Progressbars
                                                    </button>
                                                    <button class="btn btn-danger btn-o margin-bottom-10 reset-progressbar"
                                                            type="button">
                                                        Reset
                                                    </button>
                                                    <p>
                                                    ...
                                                    <div class="progress progress-animated">
                                                        <div class="progress-bar progress-bar-info" role="progressbar"
                                                             data-transitiongoal="40" data-display-text="fill"
                                                             data-use-percentage="false"></div>
                                                    </div>
                                                    <p>
                                                        Transition delay
                                                    </p>
                                                    <div class="progress progress-animated">
                                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                                             ...
                                                             data-transition-delay="1000"></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                ...
                                Simple pagination, great for apps and search results. The large block is hard to miss,
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                Simple pagination, great for apps and search results. The large block is
                                                hard to miss, easily scalable, and provides large click areas.
                                            </p>
                                            <div>
                                            ...
                                            <p class="text-small">
                                                Fancy larger or smaller pagination? Add <code>.pagination-lg</code> or
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                This jQuery plugin simplifies the usage of Bootstrap Pagintion. It uses
                                                appropriate classes: <code>.pagination</code> (you change this one),
                                                <code>.active</code> and <code>.disabled</code>.
                                                Check out the demo.
                                            </p>
                                            <div class="row">
                                                <div class="col-sm-6">
                ...
                <div class="container-fluid container-fullw">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                Using Twitter Bootstrap, you may create inline labels, i.e. Label and annotate text and
                                badges, i.e. indicators and unread counts.
                            </p>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="panel panel-white">
                                ...
                                <div class="col-sm-6">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-small">
                                                Easily highlight new or unread items by adding a <code>&lt;span
                                                class="badge"&gt;</code> to links, Bootstrap navs, and more.
                                            </p>
                                            <table class="table">
                                                <thead>
                                                <tr>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                Bootstrap Rating is a jQuery plugin that creates a rating control that uses Bootstrap
                                glyphicons for rating symbols.
                            </p>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="margin-bottom-15 text-extra-large">
                                                <input type="hidden" class="rating" readonly="readonly" value="4.5"
                                                       data-stop="10"/>
                                                <span class="label label-success"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="margin-bottom-30 text-extra-large">
                                                <input type="hidden" class="rating-tooltip"
                                                       data-filled="fa fa-star margin-right-5 text-yellow"
                                                       data-empty="fa fa-star-o margin-right-5"/>
                                                <span class="label label-success"></span>
                                            </div>
                                            <div class="margin-bottom-15 text-extra-large">
                                                <input type="hidden" class="rating-tooltip"
                                                       data-filled="fa fa-heart margin-right-5 text-red"
                                                       data-empty="fa fa-heart-o margin-right-5" data-stop="10"/>
                                                <span class="label label-success"></span>
                                            </div>
                                        </div>
                                    </div>
