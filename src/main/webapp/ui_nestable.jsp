...
<head>
    ...
    <link href="vendor/nestable/jquery.nestable.css" rel="stylesheet" media="screen">
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Nestable List</h1>
                            <span class="mainDescription">Drag &amp; drop hierarchical list with mouse and touch compatibility</span>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h5>Data binding</h5>
                                <div class="well" id="nestable-output">
